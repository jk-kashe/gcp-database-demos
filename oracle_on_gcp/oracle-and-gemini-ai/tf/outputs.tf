...
output "agent_invoke_command" {
  ...
  value       = "To query your agent, run the following command from the 'oracle_on_gcp/oracle-and-gemini-ai' directory: cd ../../modules/adk-reasoning-engine/src && chmod +x invoke.sh && ./invoke.sh \"your natural language query\""
}
