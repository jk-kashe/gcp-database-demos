...
module "landing_zone" {
  ...
  additional_apis         = ["secretmanager.googleapis.com", "cloudbuild.googleapis.com", "servicedirectory.googleapis.com", "dns.googleapis.com", "discoveryengine.googleapis.com", "aiplatform.googleapis.com"]
}
