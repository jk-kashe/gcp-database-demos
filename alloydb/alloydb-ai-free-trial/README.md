...
This repository provides deployment scripts for AlloyDB Free Trial with AlloyDB AI capabilities enabled
...
2. **Deployment:**
    ...
    * Run these commands:
    ...
    cd gcp-database-demos/alloydb/alloydb-ai-free-trial
    make apply
    ```
